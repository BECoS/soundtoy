...
//end ADSR 
  ...
  $('#adsr-wrapper').before('<h1 class="instrument">Additive &#43;</h1>');
      $('#adsr-container').after('<!-- Squared ONE --><div class="squaredOne"><input type="checkbox" value="None" id="squaredOne" name="check"></input><label for="squaredOne"></label></div>');
  ...
  function drawBackground(graphLayer, xcount, ycount, width, color) {
    ...
    canvas.height = 110;//ycount * width + 1;
